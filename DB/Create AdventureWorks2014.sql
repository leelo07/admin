...
/****** Object:  Database [AdventureWorks2014]    Script Date: 2/13/2018 2:25:51 PM ******/
CREATE DATABASE [AdventureWorks2014]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AdventureWorks2014_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\AdventureWorks2014_Data.mdf' , SIZE = 209920KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB )
 LOG ON 
( NAME = N'AdventureWorks2014_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\AdventureWorks2014_log.ldf' , SIZE = 1536KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
GO
...
EXEC [AdventureWorks2014].sys.sp_addextendedproperty @name=N'MS_Description', @value=N'AdventureWorks 2012 Sample OLTP Database' 
GO
